...
namespace RTS_test
{
    public class DisFieldMixer
    {
        ...
        public Vector2 getNormal(Vector2 pos)
        {
            ...
            Vector2 a = getDis(pos + new Vector2(-0.01f, -0.01f)) * Vector2.Normalize(new Vector2(-0.01f, -0.01f));
            Vector2 b = getDis(pos + new Vector2(+0.01f, -0.01f)) * Vector2.Normalize(new Vector2(+0.01f, -0.01f));
            Vector2 c = getDis(pos + new Vector2(-0.01f, +0.01f)) * Vector2.Normalize(new Vector2(-0.01f, +0.01f));
            Vector2 d = getDis(pos + new Vector2(+0.01f, +0.01f)) * Vector2.Normalize(new Vector2(+0.01f, +0.01f));
