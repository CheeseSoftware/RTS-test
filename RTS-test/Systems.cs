...
namespace RTS_test
{
    namespace system
    {
        ...
        public class UnitController : EntityProcessingSystem<component.Goal>
        {
            public UnitController()
                : base(Aspect.All(typeof(component.Goal)))
            {
            }
            ...
            protected override void Process(Entity e, component.Goal goal)
            {
                if (Global.globalGoal == null)
                    return;

                goal.pathGoal = Global.globalGoal;
            }
        }
